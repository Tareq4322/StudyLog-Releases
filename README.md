...
<p align="center">
  <video src="videos/showcase_video.mp4" width="70%" controls alt="StudyLog Demo Video"></video>
</p>
...
Get the latest version of StudyLog from the **[Releases page](https://github.com/Tareq4322/StudyLog-Releases/releases)** in this repository.

[![Total Downloads](https://img.shields.io/github/downloads/Tareq4322/StudyLog-Releases/total)](https://github.com/Tareq4322/StudyLog-Releases/releases)
...
1. Download the `StudyLog.apk` file from the **[Releases page](https://github.com/Tareq4322/StudyLog-Releases/releases)**.  
2. Open the file on your Android device.  
3. If prompted, allow installation from **“Unknown Sources”** in your device settings.  
4. Follow the on‑screen instructions to install.

> Make sure your device only allows installation from unknown sources when you trust the source.
...
- **Usage Stats**: To track screen time and provide focus insights.  
